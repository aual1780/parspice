...
public class WorkerPool {
    ...
    void PerformThreadedDistributedTask(DistributedTaskStateDistributable<T_Request, T_Response> Distributable) throws InterruptedException {
        ...
        CancellableThread<DistributedTaskState> t1 = new CancellableThread<>(new DistributableTaskThreadWorker1(), state);
        CancellableThread<DistributedTaskState> t2 = new CancellableThread<>(new DistributableTaskThreadWorker2(), state);
        t1.start();
        t2.start();
